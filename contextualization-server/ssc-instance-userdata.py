...
instance = nova.servers.create(name="group_11_server", image=image, flavor=flavor, userdata=userdata, nics=nics,security_groups=secgroups, key_name="alessandroCloud")
